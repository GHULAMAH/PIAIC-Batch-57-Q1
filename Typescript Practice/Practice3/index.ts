...
console.log(fruites);
fruites.splice(1, 0, "banana", "grapes", "oranges"); // go to the index 1 of the array and add next mentioned values
console.log(fruites);

// slice method remove a piece if the array and creates a new array
let num_ = ["a", "b", "c", "d", "e"];
console.log(num_);
const m = num_.slice(1, 4); // go the index 1 of the array and removes next three values
